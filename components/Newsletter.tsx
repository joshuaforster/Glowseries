...
const content = {
  eyebrow: "Register for Issue 01.",
  heading: "twice a year. never spam.",
  input: {
    placeholder: "your@studio.example",
    submitLabel: "Submit →",
    hint: "New work · new projects · new pieces.",
  },
  booking: {
    eyebrow: "Book the studio.",
    body: "15-minute consultation. We'll look at your space and show you exactly what's possible — before you commit to anything.",
    primaryCta: {
      label: "Book a consultation",
      href: "mailto:hello@glowseries.com",
    },
    secondaryCta: { label: "See packages", href: "#packages" },
    meta: "hello@glowseries.com · Norwich, UK · 4 projects per month.",
  },
};
